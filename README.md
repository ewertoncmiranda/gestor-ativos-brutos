...
| `GET` | `/ativos/registrados` | `AtivoController.listarRegistrados` | `200` com `AtivoMonitoradoDTO[]` | Lista a carteira monitorada, ordenada por símbolo. Desde 2026-09-26 esta rota tambem alimenta o seletor de ativos das abas Consulta, Como funciona e Candles do painel — nao e mais usada so pela aba Monitorados. |
